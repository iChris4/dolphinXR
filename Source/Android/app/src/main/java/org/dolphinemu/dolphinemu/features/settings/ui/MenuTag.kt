...
enum class MenuTag {
    ...
    QUEST_VR_CONFIG("quest_vr_config"),
    QUEST_VR_CONFIG_CAMERA("quest_vr_config_camera"),
    QUEST_VR_CONFIG_VIRTUAL_SCREEN("quest_vr_config_virtual_screen"),
    QUEST_VR_CONFIG_RENDERING("quest_vr_config_rendering"),
    QUEST_VR_CONFIG_FRAMERATE("quest_vr_config_framerate"),
    QUEST_VR_CONFIG_HACKS("quest_vr_config_hacks"),
    QUEST_VR_CONFIG_PASSTHROUGH("quest_vr_config_passthrough"),
    QUEST_VR_CONFIG_DEBUG("quest_vr_config_debug"),
